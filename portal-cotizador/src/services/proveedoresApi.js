...
export const proveedoresApi = {
   ...
   */
  async getAll() {
    const response = await apiClient.get(API_ENDPOINTS.PROVEEDORES.BASE)
   ...
   */
  async getByCve(cve) {
    const response = await apiClient.get(API_ENDPOINTS.PROVEEDORES.BY_CVE(cve))
    return response.datos
  },
  ...
  async create(proveedorData) {
    const response = await apiClient.post(API_ENDPOINTS.PROVEEDORES.BASE, proveedorData)
    return response
  },
  ...
  async update(cve, proveedorData) {
    const response = await apiClient.put(API_ENDPOINTS.PROVEEDORES.BY_CVE(cve), proveedorData)
    return response
  },
   ...
   */
  async delete(cve) {
    const response = await apiClient.delete(API_ENDPOINTS.PROVEEDORES.BY_CVE(cve))
    return response
  },
  ...
  async searchByName(nombre) {
    const response = await apiClient.get(API_ENDPOINTS.PROVEEDORES.BY_NAME, {
      params: { nombre }
    })
    return response.datos || []
  },
  ...
  async searchByRazon(razonSocial) {
    const response = await apiClient.get(API_ENDPOINTS.PROVEEDORES.BY_RAZON, {
      params: { razonSocial }
    })
    return response.datos || []
  },

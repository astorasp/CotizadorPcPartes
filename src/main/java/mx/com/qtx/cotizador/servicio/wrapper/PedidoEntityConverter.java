...
public class PedidoEntityConverter {
    ...
    public static void addDetallesTo(
        ...
        int numDetalle = 1;
        for (mx.com.qtx.cotizador.dominio.pedidos.DetallePedido detalleCore : detallesCore) {
    ...
    public static mx.com.qtx.cotizador.dominio.pedidos.Pedido convertToDomain(
        ...
        mx.com.qtx.cotizador.dominio.pedidos.Pedido pedidoDomain = new mx.com.qtx.cotizador.dominio.pedidos.Pedido(

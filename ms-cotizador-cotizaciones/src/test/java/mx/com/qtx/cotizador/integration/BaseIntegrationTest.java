...
public abstract class BaseIntegrationTest {
    ...
    // Constantes para tests de permisos de roles (Basic Auth)
    protected static final String USER_GERENTE = "test";
    protected static final String PASSWORD_GERENTE = "test123";
    protected static final String USER_VENDEDOR = "test";
    protected static final String PASSWORD_VENDEDOR = "test123";
    protected static final String USER_INVENTARIO = "test";
    protected static final String PASSWORD_INVENTARIO = "test123";
    protected static final String USER_CONSULTOR = "test";
    protected static final String PASSWORD_CONSULTOR = "test123";

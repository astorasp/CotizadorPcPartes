...
/**
 * Entidad Promocion para ms-cotizador-pedidos.
 * 
 * Representa promociones replicadas desde ms-cotizador-componentes
 * para uso en el contexto de gestión de pedidos.
 * Mantiene la misma estructura que otras entidades Promocion del sistema.
 */
@Entity

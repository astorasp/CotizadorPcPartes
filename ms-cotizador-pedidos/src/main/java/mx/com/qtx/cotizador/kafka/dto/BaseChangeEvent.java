 ...
 * de entidades en el microservicio de pedidos.
 * 
 * @author Subagente4E - [2025-08-17 10:35:00 MST] - DTOs para eventos Kafka en ms-cotizador-pedidos
 */
public abstract class BaseChangeEvent {
    ...
    public BaseChangeEvent() {
        ...
        this.source = "ms-cotizador-pedidos";
        this.version = "1.0";
    }

...
/**
 * DTO para la actualización completa de promociones (Caso 6.2: Modificar promoción)
 * 
 * Similar a PromocionCreateRequest pero diseñado para actualizaciones.
 * El ID se toma del path parameter del endpoint, no del body.
 * Maneja la misma complejidad de tipos y detalles.
 */
public class PromocionUpdateRequest {
    ...
    public PromocionUpdateRequest(String nombre, String descripcion, 
     ...
     * (Misma lógica que PromocionCreateRequest)
     */

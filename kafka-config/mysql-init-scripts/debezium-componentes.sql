-- Script de inicialización Debezium para microservicio COMPONENTES
-- Se ejecuta automáticamente al inicializar contenedor componentes-mysql
...
SELECT 'Usuario debezium creado exitosamente para COMPONENTES' AS status;
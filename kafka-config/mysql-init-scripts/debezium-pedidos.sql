-- Script de inicialización Debezium para microservicio PEDIDOS
-- Se ejecuta automáticamente al inicializar contenedor pedidos-mysql
...
SELECT 'Usuario debezium creado exitosamente para PEDIDOS' AS status;